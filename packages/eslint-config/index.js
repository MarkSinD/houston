module.exports = {
	...
	rules: {
		...
		// A function definition should be placed as close to the top-level scope as possible
		// without breaking its captured values. This improves readability, directly improves
		// performance and allows JavaScript engines to better optimize performance.
