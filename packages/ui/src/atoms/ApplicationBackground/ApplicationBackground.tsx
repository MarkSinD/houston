...
export const ApplicationBackground: FC<PropsWithChildren<ApplicationBackgroundProps>> = ({
	isLobby = false,
		...
		<div>
			{isLobby ? (
				...
				<>
					...
					<div
						className={isBackgroundMoving ? classes.gameActionEarthFooter : classes.earthFooter}
					/>
				</>
			)}
		</div>
